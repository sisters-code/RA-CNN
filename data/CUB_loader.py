...
class CUB200_loader(data.Dataset):
    def __init__(self, root, split = 'train', transform = None):
        ...
        split_list = open(os.path.join('/home/aa/data/CUB/CUB_200_2011', 'train_test_split.txt')).readlines()
        self.idx2name = []
        classes = open(os.path.join('/home/aa/data/CUB/CUB_200_2011', 'classes.txt')).readlines()
        self._imgpath = []
        self._imglabel = []
        self.transform = None
        ...
        image_list = open(os.path.join('/home/aa/data/CUB/CUB_200_2011', 'images.txt')).readlines()
        image_list = np.array(image_list)
        label_list = open(os.path.join('/home/aa/data/CUB/CUB_200_2011', 'image_class_labels.txt')).readlines()
        ...
        if split.lower() == 'train':
            ...
            for i, fname in enumerate(train_images):
                ...
                self._imgpath.append(os.path.join('/home/aa/data/CUB/CUB_200_2011', 'images', path))
    ...
    def __getitem__(self, index):
        ...
        try:
            np.asarray(img).shape[2] == 1
        except:
            print(self._imgpath[index])
